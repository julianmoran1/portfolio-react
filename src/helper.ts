...
export const web = [
  ...
  // {
  //   title: "E-Commerce",
  //   text: "Front End para sitio web de ecommerce. Es un sitio ficticio creado con propósito de aprendizaje de utilización de Javascript. El diseño es una plantilla.",
  //   alt: "Mockup sitio web ecommerce",
  //   src: "src/images/web/mockup-rana.jpg",
  //   link: "https://julianmoran1.github.io/ecommerce/",
  //   techs: ["js"],
  // },
  {
...
export const logotipos = [
  ...
  },
  {
    ...
    text: "Isologotipo para Pinares de Carrasco",
    alt: "Isologotipo para Pinares de Carrasco",
    src: "src/images/grafico/logotipos/logo-pinares.jpg",
  },
];

export const corporativa = [
  {
...
export const sliderOptions = [
  {
    link: "/web",
    mediaSmall: "(max-width:760px)",
    mediaMedium: "(max-width:1024px)",
    srcsetSmall: "src/images/slider/mockup-ebse-carrusel760.jpg",
    srcsetMedium: "src/images/slider/mockup-ebse-carrusel1024.jpg",
    src: "src/images/slider/mockup-ebse-carrusel.jpg",
    alt: "Mockup sitio web En bici sin edad",
  },
  {
    link: "/editorial",
    mediaSmall: "(max-width:760px)",
    mediaMedium: "(max-width:1024px)",
    srcsetSmall: "src/images/slider/revista-carrusel760.jpg",
    srcsetMedium: "src/images/slider/revista-carrusel1024.jpg",
    src: "src/images/slider/revista-carrusel.jpg",
    alt: "Revista comunicambadu",
  },
  {
    link: "/logotipos",
    mediaSmall: "(max-width:760px)",
    mediaMedium: "(max-width:1024px)",
    srcsetSmall: "src/images/slider/logo-carols-carrusel760.jpg",
    srcsetMedium: "src/images/slider/logo-carols-carrusel1024.jpg",
    src: "src/images/slider/logo-carols-carrusel.jpg",
    alt: "Logo Carols",
  },
];

export const sliderCongresoOptions = [
  {
    id: 1,
    link: "#",
    mediaSmall: "(max-width:760px)",
  ...
  },
  {
    ...
    src: "src/images/congreso/acreditacion-congreso.jpg",
    alt: "Acreditación congreso",
    description: "Acreditación congreso",
  },
  {
    id: 3,
    link: "#",
...
export const sliderPinaresOptions = [
  {
    id: 1,
    link: "#",
    mediaSmall: "(max-width:760px)",
  ...
  },
  {
    ...
    src: "src/images/pinares/05_roti.jpg",
    alt: "Cartelería de Rotisería",
    description: "Cartelería de Rotisería",
  },
  {
    id: 3,
    link: "#",
    ...
    src: "src/images/pinares/04_panaderia.jpg",
    alt: "Cartelería de Panadería",
    description: "Cartelería de Panadería",
  },
  {
    id: 4,
    link: "#",
...
export const sliderGrillitoOptions = [
  {
    id: 1,
    link: "#",
    mediaSmall: "(max-width:760px)",
    ...
    srcsetSmall: "#",
    srcsetMedium: "#",
    src: "src/images/logos/logo-grillito.jpg",
    alt: "Logotipo El Grillito",
    description: "Logotipo",
  },
  {
    id: 2,
    ...
    src: "src/images/grillito/ofertas1.jpg",
    alt: "Cartelería de Ofertas El Grillito",
    description: "Cartelería de Ofertas",
  },
  {
    id: 3,
    link: "#",
